...
class ClassificationAnnotationPanel(QWidget):
    ...
    smart_confirm_requested = pyqtSignal()
    ...
    def __init__(self, parent=None):
        ...
        self.chart_widget = NativeDonutChart(self.smart_chart_placeholder)
        self.smartChartPlaceholderLayout.addWidget(
            self.chart_widget, alignment=Qt.AlignmentFlag.AlignCenter
        )
    ...
    def display_batch_inference_result(self, result_text: str, batch_predictions: dict):
        ...
        self.pending_batch_results = dict(batch_predictions or {})
        self.chart_widget.setVisible(False)
