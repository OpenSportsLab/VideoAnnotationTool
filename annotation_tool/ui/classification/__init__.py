...
class ClassificationAnnotationPanel(QWidget):
    ...
    def _configure_inference_feedback(self):
        self._inference_loading_dialog = QProgressDialog(
        ...
        self._inference_loading_dialog.setWindowTitle("Inference")
        self._inference_loading_dialog.setWindowModality(Qt.WindowModality.ApplicationModal)
        self._inference_loading_dialog.setCancelButton(None)
        self._inference_loading_dialog.setMinimumDuration(0)
        self._inference_loading_dialog.setAutoClose(False)
        self._inference_loading_dialog.setAutoReset(False)
    ...
    def show_inference_loading(self, is_loading: bool):
        ...
        if is_loading:
            self._inference_loading_dialog.setLabelText("Loading model and running inference. Please wait...")
